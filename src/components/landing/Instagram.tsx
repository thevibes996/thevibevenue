    ...
    <section>
      <div className="w-full  py-24  sm:py-32">
        ...
        <div className="w-full flex justify-center">
          {" "}
          <a target="_blank" href="https://www.instagram.com/the_vibe_venu_6699?igsh=MXg2bzUxbnRqM2NqMg%3D%3D&utm_source=qr" className="mb-12 p-2 text-center text-base md:text-3xl text-slate-500 font-mono  w-fit bg-[#ffb300] ">@TheVibeVenue</a>
        </div>
        {/* {reels.length > 0 && (
