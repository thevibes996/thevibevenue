    ...
    <div className="bg-white py-10 min-h-[90vh]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-base font-semibold leading-7 bg-black text-[#ffb300]">Schedule</h2>
        ...
        <div className="isolate mx-auto mt-10 flex flex-col sm:flex-row gap-8 justify-center ">
          {tiers.map((tier) => (
            <div className={classNames(tier.mostPopular ? "ring-2 ring-[#ffb300]" : "ring-1 ring-gray-200", " p-8 w-full")}>
              <h3 className={classNames(tier.mostPopular ? "text-[#ffb300]" : "text-gray-900", "text-lg font-semibold leading-8")}>{tier.name}</h3>
